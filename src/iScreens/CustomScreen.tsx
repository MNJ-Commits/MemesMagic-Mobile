    ...
    <SafeAreaView
      ...
      <KeyboardAvoidingView
        ...
        <View style={{flexGrow: 1}}>
          {/* Navigation Menu */}
          <View
            style={{backgroundColor: '#FF439E', padding: RFValue(10 * ratio)}}>
            {visibleSearch ? (
              <View
                style={{
                  flexDirection: 'row',
                        ...
                        style={[
                          {
                            ...
                            paddingHorizontal: RFValue(10 * ratio),
                            height: RFValue(35 * ratio),
                            borderRadius: RFValue(20 * ratio),
                            marginRight: RFValue(15 * ratio),
                            borderWidth: 1 * ratio,
                          },
                          tag == data
                            ? {
                        ...
                        <Text
                          style={[
                            tag == data
                              ...
                              : {color: '#ffffff'},
                            {
                              fontSize: RFValue(11 * ratio),
                              paddingTop: RFValue(8 * ratio),
                              paddingBottom: RFValue(5 * ratio),
                              fontFamily: 'Lucita-Regular',
                            },
                          ]}>
                          {data}
