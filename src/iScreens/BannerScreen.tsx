          ...
          <View
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                paddingVertical: RFValue(5 * ratio),
                paddingHorizontal: RFValue(10 * ratio),
              }}>
              <Text
                style={{
                  color: 'white',
                  fontSize: RFValue(8 * ratio),
                  marginTop: RFValue(2 * ratio),
                  fontFamily: 'Lucita-Regular',
                }}>
                CUSTOM
              </Text>
              ...
              <View
                ...
                <View
                  style={{
                    ...
                    borderWidth: 1,
                    borderColor: '#ffffff',
                    height: RFValue(35.5 * ratio),
                  }}>
                  <Search
                    width={RFValue(20 * ratio)}
                    height={RFValue(20 * ratio)}
                    style={{marginHorizontal: RFValue(10 * ratio)}}
                  />
                  <TextInput
                    editable={true}
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  style={{
                    borderWidth: 1,
                    borderColor: '#ffffff',
                    width: RFValue(35 * ratio),
                    height: RFValue(35 * ratio),
                    padding: RFValue(6 * ratio),
                    borderRadius: RFValue(20),
                    marginRight: RFValue(10 * ratio),
                  }}>
                  <Search
                    width={RFValue(20 * ratio)}
                    height={RFValue(20 * ratio)}
                ...
                <View
                  style={{
                    ...
                    justifyContent: 'space-around',
                    width: '85%',
                    paddingHorizontal: RFValue(15 * ratio),
                    alignItems: 'center',
                    backgroundColor: '#ffffff',
                    borderRadius: RFValue(20),
                    padding: RFValue(5 * ratio),
                  }}>
                  <TouchableOpacity
                    onPress={() => {
              ...
              {Colors.map((data: any) => {
                return (
                  <TouchableOpacity
                    ...
                    style={{
                      width: RFValue(55 * ratio),
                      height: RFValue(55 * ratio),
                      justifyContent: 'center',
                      alignItems: 'center',
                    }}>
                    <View
