...
//RCT_EXTERN_METHOD(Sentence)
//RCT_EXTERN_METHOD(getInitialString: (RCTResponseSenderBlock) callback )
//RCT_EXTERN_METHOD(checkString: (RCTPromiseResolveBlock) resolve
